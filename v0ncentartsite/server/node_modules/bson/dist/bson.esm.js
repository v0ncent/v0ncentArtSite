...
var detectRandomBytes = function () {
    if (typeof window !== 'undefined') {
        ...
        if (target_1 && target_1.getRandomValues) {
            return function (size) {
                return target_1.getRandomValues(Buffer.alloc(size));
            };
        }
    }
    if (typeof global !== 'undefined' && global.crypto && global.crypto.getRandomValues) {
        ...
        return function (size) {
            return global.crypto.getRandomValues(Buffer.alloc(size));
        };
    }
    ...
    if (typeof value === 'number' && (!options.relaxed || !isFinite(value))) {
        ...
        if (Math.floor(value) === value) {
            var int32Range = value >= BSON_INT32_MIN$1 && value <= BSON_INT32_MAX$1,
                int64Range = value >= BSON_INT64_MIN$1 && value <= BSON_INT64_MAX$1;
